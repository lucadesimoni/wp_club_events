...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'ce-single-event' ); ?>>
    ...
    <div class="ce-event-hero" style="--ce-color:<?php echo esc_attr( $color ); ?>">
        ...
        <div class="ce-event-hero-img"><?php the_post_thumbnail( 'large' ); ?></div>
        <?php endif; ?>
                ...
                <div class="ce-event-meta-bar">
                    ...
                    <div class="ce-meta-pill">
                        ...
                        <span>
                            ...
                            <?php if ( $end_ts && $end_ts !== $start_ts ) : ?>
                            – <?php echo esc_html( date_i18n( $date_fmt, $end_ts ) ); ?>
                            <?php endif; ?>
                            <?php else : ?>
                            <?php echo esc_html( date_i18n( $date_fmt, $start_ts ) ); ?>
                            <?php echo esc_html( date_i18n( $time_fmt, $start_ts ) ); ?>
                            <?php if ( $end_ts ) : ?>
                            – <?php echo esc_html( date_i18n( $time_fmt, $end_ts ) ); ?>
                            <?php endif; ?>
                            <?php endif; ?>
                        </span>
                    </div>
                ...
                <div class="ce-detail-row">
                    ...
                    <div>
                        ...
                        <p>
                            <?php if ( $all_day ) : ?>
                            <?php echo esc_html( date_i18n( $date_fmt, $start_ts ) ); ?>
                            <?php if ( $end_ts && date( 'Ymd', $start_ts ) !== date( 'Ymd', $end_ts ) ) : ?>
                            – <?php echo esc_html( date_i18n( $date_fmt, $end_ts ) ); ?>
                            <?php endif; ?>
                            <?php else : ?>
